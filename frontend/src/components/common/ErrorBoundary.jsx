  ...
  render() {
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[400px] text-center p-8">
        ...
        <p className="text-zinc-600 dark:text-zinc-400 text-sm mb-6 max-w-md">
        ...
        {import.meta.env.DEV && this.state.error && (
          <details className="mt-6 text-left w-full max-w-lg">
            <summary className="text-xs text-zinc-500 dark:text-zinc-500 cursor-pointer">Stack trace</summary>
            <pre className="mt-2 text-xs text-red-600 dark:text-red-400 bg-red-100 dark:bg-red-500/5 p-4 rounded-xl overflow-auto">
